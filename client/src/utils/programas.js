...
maquinaria:[
    // CAEX ( 1 )
    {
        caex: {
            caex_Grua: [
                ...
                foo: 'El valor sólo es matrícula y todos los beneficios del programa seleccionado.', 
                plan: 1,
                active: true,
            ...
            caex_Cat: [
                {
                title: 'CAMIÓN EXTRACCIÓN MECÁNICOS',
                nexo: 'CAT 797F 793F',
                ...
                detalles: [
                    ...
                    ['Soporte', 'Soporte al alumno'],
                    ['Metodología', 'Campus virtual'],
                    ['Bonus', 'Introduccion a la mineria'],
                  ],
                  modulos: [
    ...
    // GRUA ( 2 )
    {
        grua: {
            ...
            grua_Retro: [
                ...
                subtitle: 'Programa dúo',
                other: 'Matrícula',
                price: '20% DESCUENTO',
                detalles: [
                    ['Maquinarias', '2 Maquinaria'],
                    ['Modalidad', 'E-Learning'],
                    ['Duración', '2 Meses'],
                    ['Clases', 'A tu ritmo'],
                    ['Horario', 'A tu ritmo'],
                  ...
                  modulos: [
                    ...
                    ['Módulo 3', 'El Lugar de Trabajo'],
                    ['Módulo 4', 'Introducción a la mineria'],
                    ['Módulo 5', 'Tipos y Fundamentos Retroexcavadora'],
                    ['Módulo 6', 'Operación Segura de Retroexcavadora'],
                    
                  ],
                foo: 'El valor inclutye matrícula y todos los beneficios del programa seleccionado.', 
                plan: 2,
                active: true,
                valorPromocion: '560.000',
                valorMatricula: '0',
                valorContado: '369.000',
                dosCuotas: '0',
                },
            ],  
        }
        ...
        retro: {
            ...
            retro_Grua: [
                ...
                detalles: [
                  ...
                  modulos: [
                    ['Módulo 1', 'Tipos y Fundamentos'],
                    ['Módulo 2', 'Operación Segura de Retroexcavadora'],
                    ['Módulo 3', 'El Lugar de Trabajo'],
                    ['Módulo 4', 'Introducción a la mineria'],
                    ['Módulo 5', 'Tipos y Fundamentos Grúa Horquilla'],
                    ['Módulo 6', 'Operación Segura de Grúa Horquilla'],
        ...
        cargador: {
            cargador_learning: [
                ...
                detalles: [
                    ...
                    ['Horario', 'A tu ritmo'],
                    ['Prácticas', '2 horas'],
                    ['Lugar', 'Disponibilidad de viajar'],
                    ['Certificación', 'Digital'],
                    ['Instructor', 'Tutor especializado'],
                    ['Soporte', 'Soporte al alumno'],
                    ['Metodología', 'Campus virtual'],
                  ...
                  modulos: [
                    ['Módulo 1', 'Tipos y Fundamentos'],
                    ['Módulo 2', 'Operación Segura de Cargador Frontal'],
                    ['Módulo 3', 'El Lugar de Trabajo'],
                    ['Módulo 4', 'Introducción a la mineria'],
                  ],
                foo: 'El valor incluye matrícula y todos los beneficios del programa seleccionado.', 
        ...
        moto: {
            moto_learning: [
                ...
                detalles: [
                  ...
                  modulos: [
                    ['Módulo 1', 'Tipos y Fundamentos'],
                    ['Módulo 2', 'Operación Segura de Motoniveladora'],
                    ['Módulo 3', 'El Lugar de Trabajo'],
                    ['Módulo 4', 'Introducción a la mineria'],
                  ],
                foo: 'El valor incluye matrícula y todos los beneficios del programa seleccionado.', 
            ...
            moto_Bull: [
                {
                title: 'OPERACIÓN SEGURA MOTONIVELADORA + ',
                nexo: 'BULLDOZER',
                subtitle: 'Programa dúo',
                other: 'Matrícula',
                price: '40% DESCUENTO',
                ...
                plan: 5,
                active: true,
                valorPromocion: '500.000',
                valorMatricula: '0',
                valorContado: '425.000',
                dosCuotas: '0',
                },
            ],
        }
    ...
    // BULL ( 6 )
    {
        bull: {
            ...
            bull_Moto: [
                {
                title: 'OPERACIÓN SEGURA BULLDOZER + ',
                nexo: 'MOTONIVELADORA',
                subtitle: 'Programa dúo',
                other: 'Matrícula',
                price: '40% DESCUENTO',
